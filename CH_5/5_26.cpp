...
int main(){
    ...
    // writing Final Reports in File
    ofstream    outPut("program26.txt");
    outPut<<"+=============================================="                       <<"+"<<endl;
    outPut<<"| Your Balance is             : "<<setw(15)<<left<<balance             <<"|"<<endl;
    outPut<<"| Total Amount of Deposit     : "<<setw(15)<<left<<total_deposit       <<"|"<<endl;
    outPut<<"| Total Amount of Withdrawals : "<<setw(15)<<left<<total_withdrawls    <<"|"<<endl;
    outPut<<"| Total Intrest Earned        : "<<setw(15)<<left<<total_intrest       <<"|"<<endl;
    outPut<<"+=============================================="                       <<"+"<<endl;
    outPut.close();   
    // it is good habit to close the file once you done
    }
    else{
